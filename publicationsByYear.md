...
* F. Mecerhed, Y. Imine, A. Gallais, S. Fischer, M. A. Hail, [ABAC-NDN: An Open-Source Security Library for Attribute-Based Access Control in NDN](https://dl.acm.org/doi/abs/10.1007/978-3-032-35576-8_28), in Proc. of Availability, Reliability and Security (ARES, International Workshops) - Linköping, Sweden, Aug. 2026.
...
* Y. Sellami, Y. Imine and A. Gallais, [A Distributed and Collaborative NTRU-based Cryptographic Scheme for Edge-IoT Architecture](https://ieeexplore.ieee.org/document/11161196), in Proc. IEEE International Conference on Communications (ICC) - Montreal, QC, Canada, pp. 4239-4244, June 2025.
...
* A. Haj-Hassan, Y. Imine, A. Gallais and B. Quoitin, [Consensus-Based Mutual Authentication Scheme for Industrial IoT](https://doi.org/10.1016/j.adhoc.2023.103162), in Elsevier Ad Hoc Networks, 2023.
